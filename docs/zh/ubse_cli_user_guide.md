...
| 字段名               | 字段描述                                    | 字段取值 |
|-------------------|-----------------------------------------|------|
| -g <br/> --global | 可选；仅用于clos组网分层选举场景下，展示集群内全局主/备/从/级联选主情况 | /    |
...
node                  role                 bonding-eid                               guid
---------------------------------------------------------------------------------------------------------------------------
computer01(1)         global master        4245:4944:0000:0000:0000:0000:0100:0000   CC08-A000-0-0-000000-0000000800800100
computer05(5)         global cascade       4245:4944:0000:0000:0000:0000:0200:0000   CC08-A000-0-0-000000-0000000801800100
---------------------------------------------------------------------------------------------------------------------------
```

#### 场景8: clos组网4组场景下查询全局主/备/级联情况
...
---------------------------------------------------------------------------------------------------------------------------
computer01(1)         global master        4245:4944:0000:0000:0000:0000:0100:0000   CC08-A000-0-0-000000-0000000800800100
computer03(3)         global standby       4245:4944:0000:0000:0000:0000:0100:0000   CC08-A000-0-0-000000-0000000800800100
computer05(5)         global cascade       4245:4944:0000:0000:0000:0000:0200:0000   CC08-A000-0-0-000000-0000000801800100
computer07(7)         global cascade       4245:4944:0000:0000:0000:0000:0200:0000   CC08-A000-0-0-000000-0000000801800100
---------------------------------------------------------------------------------------------------------------------------
```

#### 场景9：clos组网8组场景下查询全局主/备/从/级联情况
...
---------------------------------------------------------------------------------------------------------------------------
computer01(1)         global master        4245:4944:0000:0000:0000:0000:0100:0000   CC08-A000-0-0-000000-0000000800800100
computer02(2)         global standby       4245:4944:0000:0000:0000:0000:0100:0000   CC08-A000-0-0-000000-0000000800800100
computer03(3)         global agent         4245:4944:0000:0000:0000:0000:0200:0000   CC08-A000-0-0-000000-0000000801800100
computer04(4)         global agent         4245:4944:0000:0000:0000:0000:0200:0000   CC08-A000-0-0-000000-0000000801800100
computer05(5)         global cascade       4245:4944:0000:0000:0000:0000:0100:0000   CC08-A000-0-0-000000-0000000800800100
computer06(6)         global cascade       4245:4944:0000:0000:0000:0000:0100:0000   CC08-A000-0-0-000000-0000000800800100
computer07(7)         global cascade       4245:4944:0000:0000:0000:0000:0200:0000   CC08-A000-0-0-000000-0000000801800100
computer08(8)         global cascade       4245:4944:0000:0000:0000:0000:0200:0000   CC08-A000-0-0-000000-0000000801800100
---------------------------------------------------------------------------------------------------------------------------
```

#### 场景10：clos组网8组场景下级联机柜全部下线，查询全局主/备/从情况
...
#### 场景11：clos组网8组场景下全局从节点所在机柜节点全部下线，查询全局主/备/级联情况
...
#### 场景12：clos组网8组场景下级全局备/从节点所在机柜节点全部下线，查询全局主/级联情况
...
#### 场景13：clos组网8组场景下级全局备/从/级联节点所在机柜节点全部下线，查询全局主情况
...
name            size    strategy
------------------------------------------------
alloc-space-1   10737418240     Linear
alloc-space-2   21474836480     Striped
------------------------------------------------
```
...
| -n/--name | **必选**，按分配名称查询 | 字符串，1-47字符，仅支持大小写字母、数字、`.`、`:`、`-`和`_` |
...
----------------------------------------------------------------------------------------------------------------
uuid-aa    e2         nqn.2024-01:target  1               /dev/nvme0n1    10737418240        4K
uuid-bb    e3         nqn.2024-01:target  2               /dev/nvme1n1    10737418240        4K
----------------------------------------------------------------------------------------------------------------
```
...
| 参数             | 说明                  | 取值                                                                 |
| -------------- | ------------------- | ------------------------------------------------------------------ |
| -n/--name      | **必选**，分配空间标识名称 | 字符串，1-47字符，仅支持大小写字母、数字、`.`、`:`、`-`和`_`                         |
...
ns_uuid    tgt_eid    tgt_nqn             namespace_id    ns_dev_path     ns_size    lba_format
----------------------------------------------------------------------------------------------------------------
uuid-aa    e2         nqn.2024-01:target  1               /dev/nvme0n1    10737418240        512B
----------------------------------------------------------------------------------------------------------------
```
...
释放SSU存储空间，删除该分配空间及其关联的所有命名空间。

**用法**

```shell
ubsectl-ssu delete -n <name>
```
...
```shell
$ ubsectl-ssu delete -n alloc-space-1
```
