...
对于异常场景如username、uid改变或者用户被删除，ubse提供cli命令删除内存能力,具体请参考《[ubse_cli_user_guide.md](ubse_cli_user_guide.md)》文档。
...
| name      | IN/OUT | description                                                                       |
| --------- | ------ |-----------------------------------------------------------------------------------|
| name      | IN     | 借用标识，name最大长度48字节，含结尾字符 `\0`<br>name仅可包括大小写字母、数字、`.`、`:`、`-` 以及 `_`<br>name全局保持唯一性 |
