...
- **方式二：yum手动安装**
    ...
    ```shell
    yum install -y libboundscheck libxml2-devel numactl-libs openssl-devel rapidjson-devel patch libvirt-devel 'cpp-httplib-devel >= 0.40.0' 'ubs-comm-devel >= 1.0.0-15' ...
    ```
