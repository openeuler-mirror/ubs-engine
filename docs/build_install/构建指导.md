...
- **方式二：yum手动安装**
    ...
    ```shell
    yum install -y libboundscheck libxml2-devel numactl-libs openssl-devel rapidjson-devel patch libvirt-devel kernel-devel 'cpp-httplib-devel >= 0.40.0' 'ubs-comm-devel >= 1.0.0-15' ...
    ```
...
mkdir -p /tmp/src
# 下载 ubs-comm 源码
git clone -b openEuler-24.03-LTS-SP3 https://gitcode.com/src-openeuler/ubs-comm.git /tmp/src/ubs-comm
# 初始化 rpmbuild 目录结构
rpmdev-setuptree
