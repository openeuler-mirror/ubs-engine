...
高安相关配置涉及 ubm.server.cid、ubse.server.port、ubm.server.hostname和ubm.server.port 四个个参数，具体取值和说明详见配置内容 [UBFM对接配置说明](../zh/ubse/ubse_configration_instructions.md#ubfm对接配置说明)。
