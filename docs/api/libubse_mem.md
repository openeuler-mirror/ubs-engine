...
| name     | IN/OUT | description                                                        |
| -------- | ------ | ------------------------------------------------------------------ |
| name     | IN     | 借用标识，最大长度48字节，含结尾字符 `\0`；仅可包括大小写字母、数字、`.`、`:`、`-` 以及 `_`；在节点内保持唯一性 |
...
| name      | IN/OUT | description                                                                                     |
| --------- | ------ | ----------------------------------------------------------------------------------------------- |
| name      | IN     | 借用标识，最大长度48字节，含结尾字符 `\0`；仅可包括大小写字母、数字、`.`、`:`、`-` 以及 `_`；全局保持唯一性                                |
| size      | IN     | 借用大小，单位Byte，取值范围大于等于 `4 * 1024 * 1024`                                                          |
...
| name      | IN/OUT | description                                                        |
| --------- | ------ | ------------------------------------------------------------------ |
| name      | IN     | 借用标识前缀，最大长度48字节，含结尾字符 `\0`；仅可包括大小写字母、数字、`.`、`:`、`-` 以及 `_`；全局保持唯一性 |
