# UBS Engine (Unified Bus Service Engine)

> **软件定义计算 · 资源按需组合与分配**

UBSE(Unified Bus Service Engine,简称UBSE或UBS Engine)提供了ubse daemon程序及其相应的SDK开发库。开发者可以利用该SDK访问ubse daemon
...
### 环境要求
- 操作系统：推荐 **openEuler 22.03 LTS 或更高版本（ARM64 架构）**
