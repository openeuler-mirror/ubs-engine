...
{
    DT_FUZZ_START(0, fuzzCount, "MemFragmentationNodeInfoFuzz", 0)
    {
...
{
    DT_FUZZ_START(0, fuzzCount, "MemFragmentationVmInfoFuzz", 0)
    {
        vm_domain_info_t *vm_info_list{};
...
TEST_F(VirtAgentMemFragmentationFuzz, FragmentationNodeAntiAffinityFuzz)
{
    DT_FUZZ_START(0, fuzzCount, "FragmentationNodeAntiAffinityFuzz", 0)
    {
...
{
    DT_FUZZ_START(0, fuzzCount, "MemBorrowStrategyFuzz", 0)
    {
        src_memory_borrow_param borrow_param;
...
TEST_F(VirtAgentMemFragmentationFuzz, MemBorrowExecuteFuzz)
{
    DT_FUZZ_START(0, fuzzCount, "MemBorrowExecuteFuzz", 0)
    {
        borrow_strategy_c borrow_strategy;
        char *rawModuleName = DT_SetGetString(&g_Element[0], 5, 10000, "123");
        std::string data = rawModuleName ? std::string(rawModuleName) : "unknown";
...
{
    DT_FUZZ_START(0, fuzzCount, "MemMigrateStrategyFuzz", 0)
    {
        MemMigrateStrategySrcParam strategy_src_param;
...
{
    DT_FUZZ_START(0, fuzzCount, "MemMigrateExecuteFuzz", 0)
    {
        MemMigrateExecuteSrcParam param = {0};
...
TEST_F(VirtAgentMemFragmentationFuzz, AgentMemReturnFuzz)
{
    DT_FUZZ_START(0, fuzzCount, "AgentMemReturnFuzz", 0)
    {
