...
TEST_F(VirtAgentContainerFuzz, WaterLineInjectFuzz)
{
    DT_FUZZ_START(0, fuzzCount, "WaterLineInjectFuzz", 0)
    {
        watermark_t param;
...
TEST_F(VirtAgentContainerFuzz, GetContainerPidsFuzz)
{
    DT_FUZZ_START(0, fuzzCount, "GetContainerPidsFuzz", 0)
    {
...
TEST_F(VirtAgentContainerFuzz, ContainerInfoQueryFuzz)
{
    DT_FUZZ_START(0, fuzzCount, "ContainerInfoQueryFuzz", 0)
    {
        pid_param param = {0};
...
{
    DT_FUZZ_START(0, fuzzCount, "WaterlineMemBorrowFuzz", 0)
    {
        mem_borrow_request_t mem_borrow_request;
        // 获取并设置 srcNid
        char *rawModuleName = DT_SetGetString(&g_Element[0], 5, 10000, "123");
        if (rawModuleName) {
...
{
    DT_FUZZ_START(0, fuzzCount, "WaterlineMemMigrateFuzz", 0)
    {
        mem_migrate_request_t mem_migrate_request;
