...
std::unique_ptr<ItCluster> Tongsuan1dFullMeshTwoNodesNormalConfigScenario::cluster_;
std::string Tongsuan1dFullMeshTwoNodesNormalConfigScenario::workDir_;

void Tongsuan1dFullMeshTwoNodesNormalConfigScenario::SetUpTestSuite()
{
...
void Tongsuan1dFullMeshTwoNodesNormalConfigScenario::TearDownTestSuite()
{
    if (cluster_) {
