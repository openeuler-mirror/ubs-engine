...
std::unique_ptr<ItCluster> ZhisuanNpuSingleNodeScenario::cluster_;
std::string ZhisuanNpuSingleNodeScenario::workDir_;
...
void ZhisuanNpuSingleNodeScenario::TearDownTestSuite()
{
    if (cluster_) {
        IT_LOG_INFO << "ZhisuanNpuSingleNodeScenario: stopping cluster...";
