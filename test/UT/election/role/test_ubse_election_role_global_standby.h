...
#ifndef UBSE_MANAGER_TEST_UBSE_ELECTION_ROLE_GLOBAL_STANDBY_H
#define UBSE_MANAGER_TEST_UBSE_ELECTION_ROLE_GLOBAL_STANDBY_H
...
class TestUbseElectionRoleGlobalStandby : public ::testing::Test {
public:
    void SetUp() override
    {
...
void TestUbseElectionRoleGlobalStandby::TearDown()
{
    Test::TearDown();
...
#endif // UBSE_MANAGER_TEST_UBSE_ELECTION_ROLE_GLOBAL_STANDBY_H
