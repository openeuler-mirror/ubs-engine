...
#ifndef UBSE_MANAGER_TEST_UBSE_ELECTION_ROLE_GLOBAL_AGENT_H
#define UBSE_MANAGER_TEST_UBSE_ELECTION_ROLE_GLOBAL_AGENT_H
...
class TestUbseElectionRoleGlobalAgent : public ::testing::Test {
public:
    void SetUp() override
    {
...
void TestUbseElectionRoleGlobalAgent::TearDown()
{
    Test::TearDown();
...
#endif // UBSE_MANAGER_TEST_UBSE_ELECTION_ROLE_GLOBAL_AGENT_H