...
uint32_t MempoolingMessageRmrsPidNumaInfoCollectMockSuccess(const turbo::rmrs::PidNumaInfoCollectParam& param,
...
uint32_t MempoolingMessageRmrsPidNumaInfoCollectMockFailed(const turbo::rmrs::PidNumaInfoCollectParam& param,
                                                           turbo::rmrs::PidNumaInfoCollectResult& result)
{
    return IPC_BAD_CONNECT;
}

uint32_t MempoolingMessageRmrsPidNumaInfoCollectMockError(const turbo::rmrs::PidNumaInfoCollectParam& param,
                                                          turbo::rmrs::PidNumaInfoCollectResult& result)
{
    return IPC_ERROR;
}
