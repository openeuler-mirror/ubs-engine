...
#ifndef TEST_UBSE_CTRL_Q_MSG_PROXY_H
#define TEST_UBSE_CTRL_Q_MSG_PROXY_H
...
class TestUbseCtrlQMsgProxy : public testing::Test {
public:
    TestUbseCtrlQMsgProxy() = default;
    void SetUp() override;
    void TearDown() override;
};
} // namespace ubse::mti::ctrl_q::ut

#endif // TEST_UBSE_CTRL_Q_MSG_PROXY_H