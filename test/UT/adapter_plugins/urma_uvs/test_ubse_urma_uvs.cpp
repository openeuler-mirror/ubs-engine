...
TEST_F(TestUrmaUvs, FillNodeComInfo) {
    std::vector<PhysicalLink> allLinkInfo;
    allLinkInfo.push_back(PhysicalLink{.slotId = 1, .chipId = 1, .portId = 1, .peerSlotId = 2, .peerChipId = 1, .peerPortId = 1});
    ...
    feList.push_back(UbseUrmaUvsFe{.ubpuId = "1", .entityId = "1", .primaryEid = "0000:0000:0000:0000:0000:0000:0000:0001",
                                   .portEid = portEid});
    ...
    feList.push_back(UbseUrmaUvsFe{.ubpuId = "2", .entityId = "1", .primaryEid = "0000:0000:0000:0000:0000:0000:0000:0006",
                                   .portEid = portEid2});
