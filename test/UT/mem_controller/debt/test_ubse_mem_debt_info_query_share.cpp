...
static std::shared_ptr<const UbseMemShareBorrowExportObj> MakeConstShareExportObj(
    UbseMemState state, const std::string &name)
{
...
static std::shared_ptr<const UbseMemShareBorrowImportObj> MakeConstShareImportObj(
    UbseMemState state, const std::string &name)
{
...
TEST_F(TestUbseMemDebtInfoQueryShare, ShmGet_ExportPermissionDenied)
{
    ...
    UbseMemDebtLedger::GetInstance().GetDebtMap<UbseMemShareBorrowExportObj>()
        .PutResource("exportNode", "test", exportObj);
...
TEST_F(TestUbseMemDebtInfoQueryShare, ShmGet_ImportOnlySuccess)
{
    ...
    UbseMemDebtLedger::GetInstance().GetDebtMap<UbseMemShareBorrowImportObj>()
...
TEST_F(TestUbseMemDebtInfoQueryShare, ShmList_ImportOnly)
{
    ...
    UbseMemDebtLedger::GetInstance().GetDebtMap<UbseMemShareBorrowImportObj>()
        .PutResource("importNode", "import_test", importObj);
...
TEST_F(TestUbseMemDebtInfoQueryShare, ShmList_NameFilter)
{
    ...
    UbseMemDebtLedger::GetInstance().GetDebtMap<UbseMemShareBorrowExportObj>()
        .PutResource("exportNode", "prefix_test", exportObj);
