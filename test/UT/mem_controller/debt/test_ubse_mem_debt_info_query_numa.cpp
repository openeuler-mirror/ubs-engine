...
TEST_F(TestUbseMemDebtInfoQueryNuma, NumaGet_PermissionDenied)
{
    ...
    UbseMemDebtLedger::GetInstance().GetDebtMap<UbseMemNumaBorrowImportObj>()
...
TEST_F(TestUbseMemDebtInfoQueryNuma, NumaGet_Success)
{
    ...
    UbseMemDebtLedger::GetInstance().GetDebtMap<UbseMemNumaBorrowExportObj>()
        .PutResource("exportNode", GenerateExportObjKey("test", "importNode"),
                     std::make_shared<UbseMemNumaBorrowExportObj>());
