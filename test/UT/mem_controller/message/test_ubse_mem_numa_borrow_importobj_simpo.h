...
#ifndef UBSE_MANAGER_TEST_MXE_MEM_NUMA_BORROW_IMPORTOBJ_SIMPO_H
#define UBSE_MANAGER_TEST_MXE_MEM_NUMA_BORROW_IMPORTOBJ_SIMPO_H
...
class TestUbseMemNumaBorrowImportobjSimpo : public testing::Test {
public:
    void SetUp() override;
