...
#ifndef UBSE_ENGINE_TEST_MXE_MEM_SHARE_BORROW_IMPORTOBJ_SIMPO_H
#define UBSE_ENGINE_TEST_MXE_MEM_SHARE_BORROW_IMPORTOBJ_SIMPO_H
...
class TestUbseMemShareBorrowImportobjSimpo : public testing::Test {
public:
    void SetUp() override;
