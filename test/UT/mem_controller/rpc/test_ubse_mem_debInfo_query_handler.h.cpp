...
TEST_F(TestUbseMemDebInfoQueryHandler, RegMxeMemGetOptResultHandler)
{
    ...
    auto ret = UbseMemDebInfoQueryHandler::RegUbseMemDebInfoQueryHandler();
    EXPECT_EQ(ret, UBSE_ERROR_NULLPTR);
    ret = UbseMemDebInfoQueryHandler::RegUbseMemDebInfoQueryHandler();
