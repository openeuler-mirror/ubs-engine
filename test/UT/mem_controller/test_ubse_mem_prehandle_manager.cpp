...
void InitDcnaByPreImportInfo(const ubse::service::mem::BasicPreImportInfo& preImportInfo,
...
TEST_F(TestUbseMemPrehandleManager, InitPreHandleFailed)
{
    ...
    std::vector<ubse::service::mem::BasicPreImportInfo> preImportInfos;
...
TEST_F(TestUbseMemPrehandleManager, InitDcnaByPreImportInfoMatchingPa)
{
    ...
    ubse::service::mem::BasicPreImportInfo preImportInfo{};
