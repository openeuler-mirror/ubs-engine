# 命令示意：ubse_ssu_test_go

## 1. 基本格式

命令扁平下划线形式，直接跟在 `ubse_ssu_test_go` 后执行一次。

```text
ubse_ssu_test_go help
ubse_ssu_test_go help ssu_alloc_space
ubse_ssu_test_go ssu_list_alloc_info
```
