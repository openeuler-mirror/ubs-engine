...
BuildRequires:  libboundscheck >= v1.1 libxml2-devel >= 2.9 openssl >= 1.1.1 ubs-comm-devel
BuildRequires:  numactl-libs >= 2.0
BuildRequires:  ninja-build >= 1.10 bash bc coreutils sudo util-linux-user
Requires: glibc >= 2.34 libgcc >= 10.3 libstdc++ >= 10.3 libboundscheck >= v1.1 libxml2 >= 2.9 openssl >= 1.1.1 ubs-comm-lib
