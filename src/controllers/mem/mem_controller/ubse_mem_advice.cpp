...
const auto& GetAdviceStrMap()
{
    static const std::unordered_map<MemAdvice, const char*> map = {
        ...
        {MA::RES_OP_CONFLICT, "please wait for the resource creation or deletion operation to finish."},
        {MA::NO_OP_PERMISSION, "please check whether the user has permission to operate this resource."},
...
const auto& GetFaultCodeMap()
{
    static const std::unordered_map<MemFault, FaultInfo> map = {
        ...
        {MF::BORROW_MASTER_TO_EX_SEND_FAILED,
         {PT::BORROW_FAILED, MA::COMM_FAILED, "the master node failed to send messages to export node"}},
        {MF::BORROW_MASTER_TO_IM_SEND_FAILED,
         {PT::BORROW_FAILED, MA::COMM_FAILED, "the master node failed to send messages to import node"}},
        {MF::BORROW_MASTER_TO_REQ_SEND_FAILED,
         {PT::BORROW_FAILED, MA::COMM_FAILED, "the master node failed to send messages to request node"}},
        {MF::BORROW_EXPORT_SEND_FAILED,
         {PT::EXPORT_FAILED, MA::COMM_FAILED, "the export node failed to send messages to master node"}},
        {MF::BORROW_IMPORT_SEND_FAILED,
         {PT::IMPORT_FAILED, MA::COMM_FAILED, "the import node failed to send messages to master node"}},
        {MF::BORROW_REQ_SEND_FAILED,
         {PT::BORROW_FAILED, MA::COMM_FAILED, "the request node failed to send messages to master node"}},
        ...
        {MF::SHARED_ATTACH_AUTH_FAILED,
         {PT::IMPORT_FAILED, MA::NO_OP_PERMISSION, "the shared attach authentication failed"}},
        ...
        {MF::RETURN_MASTER_TO_EX_SEND_FAILED,
         {PT::RETURN_FAILED, MA::COMM_FAILED, "The master node failed to send messages to export node"}},
        {MF::RETURN_MASTER_TO_IM_SEND_FAILED,
         {PT::RETURN_FAILED, MA::COMM_FAILED, "The master node failed to send messages to import node"}},
        {MF::RETURN_MASTER_TO_REQ_SEND_FAILED,
         {PT::RETURN_FAILED, MA::COMM_FAILED, "The master node failed to send messages to request node"}},
        {MF::RETURN_EXPORT_SEND_FAILED,
         {PT::UNEXPORT_FAILED, MA::COMM_FAILED, "the export node failed to send messages to master node"}},
        {MF::RETURN_IMPORT_SEND_FAILED,
         {PT::UNIMPORT_FAILED, MA::COMM_FAILED, "the import node failed to send messages to master node"}},
        {MF::RETURN_REQ_SEND_FAILED,
         {PT::RETURN_FAILED, MA::COMM_FAILED, "the request node failed to send messages to master node"}},
        {MF::RETURN_REQ_CONFLICT,
         {PT::RETURN_FAILED, MA::RES_OP_CONFLICT, "the return request conflicts with another operation"}},
        {MF::RETURN_AUTH_FAILED, {PT::RETURN_FAILED, MA::NO_OP_PERMISSION, "the return authentication failed"}},
        ...
        // SHARED_RETURN_*
        {MF::SHARED_RETURN_IN_ATTACH, {PT::RETURN_FAILED, MA::RES_OP_CONFLICT, "the shared memory is still in attach"}},
        {MF::SHARED_RETURN_REG_FAILED,
         {PT::RETURN_FAILED, MA::CHECK_FAILED, "the request node is not in the shared region"}},
        {MF::SHARED_DETACH_AUTH_FAILED,
         {PT::UNIMPORT_FAILED, MA::NO_OP_PERMISSION, "the shared detach authentication failed"}},
        {MF::SHARED_DETACH_REQ_CONFLICT,
         {PT::UNIMPORT_FAILED, MA::RES_OP_CONFLICT, "the detach request conflicts with another operation"}},
