...
#include "ubse_mem_return_req_simpo.h"
...
UbseResult UbseMemReturnReqSimpo::Serialize()
{
    UbseSerialization out;
    if (!UbseMemReturnReqSerialize(out, req_)) {
...
UbseResult UbseMemReturnReqSimpo::Deserialize()
{
    ...
    if (!UbseMemReturnReqDeserialize(in, req_)) {
