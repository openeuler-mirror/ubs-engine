...
#include "ubse_mem_share_attach_req_simpo.h"
...
UbseResult UbseMemShareAttachReqSimpo::Serialize()
{
    UbseSerialization out;
    if (!UbseMemShareAttachReqSerialization(out, req_)) {
...
UbseResult UbseMemShareAttachReqSimpo::Deserialize()
{
    ...
    if (!UbseMemShareAttachReqDeserialization(in, req_)) {
