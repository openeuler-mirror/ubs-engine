...
UbseResult UbseMemOptReqSimpo::Serialize()
{
    UbseSerialization out;
    out << name_ << enum_v(borrowType_) << importNodeId_;
    if (!out.Check()) {
...
UbseResult UbseMemOptReqSimpo::Deserialize()
{
    ...
    in >> name_ >> enum_v(borrowType_) >> importNodeId_;
    if (!in.Check()) {
