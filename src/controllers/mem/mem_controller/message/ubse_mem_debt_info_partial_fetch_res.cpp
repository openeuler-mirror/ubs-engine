...
UbseResult UbseMemDebtInfoPartialFetchRes::Serialize()
{
    UbseSerialization out;
    if (!PartialFetchRes::Serialize(out, partialFetchRes)) {
...
UbseResult UbseMemDebtInfoPartialFetchRes::Deserialize()
{
    ...
    if (!PartialFetchRes::Deserialize(in, partialFetchRes)) {
