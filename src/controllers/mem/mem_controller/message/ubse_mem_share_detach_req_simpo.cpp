...
#include "ubse_mem_share_detach_req_simpo.h"
...
UbseResult UbseMemShareDetachReqSimpo::Serialize()
{
    UbseSerialization out;
    if (!UbseMemShareDetachReqSerialization(out, req_)) {
...
UbseResult UbseMemShareDetachReqSimpo::Deserialize()
{
    ...
    if (!UbseMemShareDetachReqDeserialization(in, req_)) {
