...
#include "ubse_mem_share_borrow_exportobj_simpo.h"
...
UbseResult UbseMemShareBorrowExportobjSimpo::Serialize()
{
    UbseSerialization out;
    if (!UbseMemShareBorrowExportObjSerialization(out, exportObj_)) {
...
UbseResult UbseMemShareBorrowExportobjSimpo::Deserialize()
{
    ...
    if (!UbseMemShareBorrowExportObjDeserialization(in, exportObj_)) {
