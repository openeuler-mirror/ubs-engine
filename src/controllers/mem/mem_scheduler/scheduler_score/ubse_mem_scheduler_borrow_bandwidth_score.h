...
#ifndef UBSE_MEM_SCHEDULER_BORROW_BANDWIDTH_SCORE_H
#define UBSE_MEM_SCHEDULER_BORROW_BANDWIDTH_SCORE_H

#include "ubse_mem_scheduler_score.h"

namespace ubse::mem::scheduler {

class BorrowBandwidthScore : public SchedulerScore {
public:
    ...
    {
        return "BorrowBandwidthScore";
    }
};

} // namespace ubse::mem::scheduler

#endif // UBSE_MEM_SCHEDULER_BORROW_BANDWIDTH_SCORE_H
