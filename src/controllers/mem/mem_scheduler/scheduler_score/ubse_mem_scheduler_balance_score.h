...
#ifndef UBSE_MEM_SCHEDULER_BALANCE_SCORE_H
#define UBSE_MEM_SCHEDULER_BALANCE_SCORE_H

#include "ubse_mem_scheduler_score.h"

namespace ubse::mem::scheduler {

class BalanceScore : public SchedulerScore {
public:
...
#endif // UBSE_MEM_SCHEDULER_BALANCE_SCORE_H
