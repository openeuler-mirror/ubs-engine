...
#ifndef UBSE_MEM_SCHEDULER_DIVIDE_NUMA_SCORE_H
#define UBSE_MEM_SCHEDULER_DIVIDE_NUMA_SCORE_H

#include "ubse_mem_scheduler_score.h"

namespace ubse::mem::scheduler {

class DivideNumaScore : public SchedulerScore {
public:
    ...
    {
        return "DivideNumaScore";
    }
};

} // namespace ubse::mem::scheduler

#endif // UBSE_MEM_SCHEDULER_DIVIDE_NUMA_SCORE_H
