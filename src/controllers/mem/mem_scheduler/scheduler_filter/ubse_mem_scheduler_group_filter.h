...
#ifndef UBSE_MEM_SCHEDULER_GROUP_FILTER_H
#define UBSE_MEM_SCHEDULER_GROUP_FILTER_H

#include "ubse_mem_scheduler_filter.h"

namespace ubse::mem::scheduler {

class GroupFilter : public SchedulerFilter {
public:
...
#endif // UBSE_MEM_SCHEDULER_FILTER_GROUP_H
