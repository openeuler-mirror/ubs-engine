...
#ifndef UBSE_MEM_SCHEDULER_PROVIDER_FILTER_H
#define UBSE_MEM_SCHEDULER_PROVIDER_FILTER_H

#include "ubse_mem_scheduler_filter.h"

namespace ubse::mem::scheduler {

class ProviderFilter : public SchedulerFilter {
public:
...
#endif // UBSE_MEM_SCHEDULER_FILTER_PROVIDER_H
