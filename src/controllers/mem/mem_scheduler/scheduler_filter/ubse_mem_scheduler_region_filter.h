...
#ifndef UBSE_MEM_SCHEDULER_REGION_FILTER_H
#define UBSE_MEM_SCHEDULER_REGION_FILTER_H

#include "ubse_mem_scheduler_filter.h"

namespace ubse::mem::scheduler {

class RegionFilter : public SchedulerFilter {
public:
...
#endif // UBSE_MEM_SCHEDULER_FILTER_REGION_H
