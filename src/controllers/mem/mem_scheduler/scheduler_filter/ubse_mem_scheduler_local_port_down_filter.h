 ...
 */
#ifndef UBSE_MEM_SCHEDULER_LOCAL_PORT_DOWN_FILTER_H
#define UBSE_MEM_SCHEDULER_LOCAL_PORT_DOWN_FILTER_H

#include "ubse_mem_scheduler_filter.h"

namespace ubse::mem::scheduler {

class LocalPortDownFilter : public SchedulerFilter {
public:
