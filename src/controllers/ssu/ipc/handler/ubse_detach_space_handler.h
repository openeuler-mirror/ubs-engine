 ...
 */
#ifndef UBS_ENGINE_UBSE_DETACH_SPACE_HANDLER_H
#define UBS_ENGINE_UBSE_DETACH_SPACE_HANDLER_H
#include "../ubse_ssu_ipc_handler.h"
#include "plugin_services/ssu/ubse_ssu_service.h"

namespace ubse::ssu::ipc {

class UbseDetachSpaceHandler : public UbseSsuHandler {
public:
    UbseDetachSpaceHandler() = default;
    ~UbseDetachSpaceHandler() override = default;
protected:
...
#endif //UBS_ENGINE_UBSE_DETACH_SPACE_HANDLER_H