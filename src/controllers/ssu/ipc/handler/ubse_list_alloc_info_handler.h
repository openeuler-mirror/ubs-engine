 ...
 */
#ifndef UBS_ENGINE_UBSE_LIST_ALLOC_INFO_HANDLER_H
#define UBS_ENGINE_UBSE_LIST_ALLOC_INFO_HANDLER_H
#include "../ubse_ssu_ipc_handler.h"
#include "plugin_services/ssu/ubse_ssu_service.h"

namespace ubse::ssu::ipc {
class UbseListAllocInfoHandler : public UbseSsuHandler {
public:
    UbseListAllocInfoHandler() = default;
    ~UbseListAllocInfoHandler() override = default;
protected:
...
#endif //UBS_ENGINE_UBSE_LIST_ALLOC_INFO_HANDLER_H
