...
UbseResult UbseDetachLinearSpaceHandler::Pack(api::server::UbseIpcMessage &response)
{
    return UBSE_OK;
}

UbseResult UbseDetachLinearSpaceHandler::Handle()
{
...
UbseResult UbseDetachLinearSpaceHandler::Unpack()
{
    ...
    return message::SsuDetachLinearSpaceUnpack(*buffer_, req);
}
