 ...
 */
#ifndef UBS_ENGINE_UBSE_ATTACH_SPACE_HANDLER_H
#define UBS_ENGINE_UBSE_ATTACH_SPACE_HANDLER_H
#include "../ubse_ssu_ipc_handler.h"
#include "plugin_services/ssu/ubse_ssu_service.h"

namespace ubse::ssu::ipc {

class UbseAttachSpaceHandler : public UbseSsuHandler {
public:
    UbseAttachSpaceHandler() = default;
    ~UbseAttachSpaceHandler() override = default;
protected:
...
#endif //UBS_ENGINE_UBSE_ATTACH_SPACE_HANDLER_H