...
UbseResult UbseAddAccessPermissionHandler::Pack(api::server::UbseIpcMessage &response)
{
    return UBSE_OK;
}

UbseResult UbseAddAccessPermissionHandler::Handle()
{
...
UbseResult UbseAddAccessPermissionHandler::Unpack()
{
    ...
    return message::SsuAddAccessPermissionUnpack(*buffer_, name, nqn);
}
