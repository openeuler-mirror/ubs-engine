 ...
 */
#ifndef UBS_ENGINE_UBSE_GET_NS_STATS_HANDLER_H
#define UBS_ENGINE_UBSE_GET_NS_STATS_HANDLER_H
#include "../ubse_ssu_ipc_handler.h"
#include "plugin_services/ssu/ubse_ssu_service.h"
namespace ubse::ssu::ipc {
class UbseGetNsStatsHandler : public UbseSsuHandler {
public:
    UbseGetNsStatsHandler() = default;
    ~UbseGetNsStatsHandler() override = default;
protected:
...
#endif //UBS_ENGINE_UBSE_GET_NS_STATS_HANDLER_H
