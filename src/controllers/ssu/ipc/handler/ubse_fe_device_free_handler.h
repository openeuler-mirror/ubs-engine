 ...
 */
#ifndef UBS_ENGINE_UBSE_FE_DEVICE_FREE_HANDLER_H
#define UBS_ENGINE_UBSE_FE_DEVICE_FREE_HANDLER_H
#include "../ubse_ssu_ipc_handler.h"
#include "plugin_services/ssu/ubse_ssu_service.h"

namespace ubse::ssu::ipc {

class UbseFeDeviceFreeHandler : public UbseSsuHandler {
public:
    UbseFeDeviceFreeHandler() = default;
    ~UbseFeDeviceFreeHandler() override = default;
protected:
...
#endif //UBS_ENGINE_UBSE_FE_DEVICE_FREE_HANDLER_H