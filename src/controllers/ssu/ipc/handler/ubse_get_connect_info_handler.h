 ...
 */
#ifndef UBS_ENGINE_UBSE_GET_CONNECT_INFO_HANDLER_H
#define UBS_ENGINE_UBSE_GET_CONNECT_INFO_HANDLER_H
...
class UbseGetConnectInfoHandler : public UbseSsuHandler {
public:
    UbseGetConnectInfoHandler() = default;
    ~UbseGetConnectInfoHandler() override = default;
protected:
...
#endif //UBS_ENGINE_UBSE_GET_CONNECT_INFO_HANDLER_H
