...
private:
    ...
    UbseResult BuildEtsProfileVlsXml(const std::vector<UbseEtsVl> &vls, std::string &xmlStr);
    UbseResult BuildEtsProfilePriorityGroupsXml(const std::vector<UbseEtsPriorityGroup> &priorityGroups,
                                                std::string &xmlStr);
