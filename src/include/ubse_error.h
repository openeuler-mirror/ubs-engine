...
#define UBSE_COM_ERROR_NO_ROUTE UBSE_INTERNAL_ERROR_DEF(214)                         /* 未找到路由 */
#define UBSE_COM_ERROR_ROUTE_EXISTED UBSE_INTERNAL_ERROR_DEF(215) /* 路由已存在，不允许动态修改 */
#define UBSE_COM_ERROR_ROUTE_INVAL UBSE_INTERNAL_ERROR_DEF(216)   /* 路由表项无效（参数非法） */
...
#define UBSE_IPC_ERROR_HANDLER_NOT_EXIST UBSE_INTERNAL_ERROR_DEF(906)    /* 未定义的handler */
...
#define UBSE_SSU_ERROR_BLOCK_DEVICE_STOP_FAILED UBSE_INTERNAL_ERROR_DEF(1324)    /* 聚合块设备停止失败（保留元数据） */
...
#define UBSE_SSU_ERROR_BLOCK_DEVICE_ASSEMBLE_FAILED UBSE_INTERNAL_ERROR_DEF(1327) /* 聚合块设备重组失败（复用元数据） */
#define UBSE_SSU_ERROR_BLOCK_DEVICE_PROBE_FAILED UBSE_INTERNAL_ERROR_DEF(1328)    /* 聚合块设备探测失败（瞬态异常，可重试） */
