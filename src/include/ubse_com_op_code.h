...
enum class UbseMemBorrowCallbackOpCode {
    ...
    // CLOS组网共享内存回调操作
    UBSE_MEM_SHARE_BORROW_GLOBAL_MASTER_TO_EXPORT_CASCADE_MASTER = 0x0010,
    UBSE_MEM_SHARE_BORROW_EXPORT_CASCADE_MASTER_TO_GLOBAL_MASTER = 0x0011,
    UBSE_MEM_SHARE_BORROW_EXPORT_AGENT_TO_CASCADE_MASTER = 0x0012,
    UBSE_MEM_SHARE_ATTACH_GLOBAL_MASTER_TO_IMPORT_CASCADE_MASTER = 0x0013,
    UBSE_MEM_SHARE_ATTACH_IMPORT_CASCADE_MASTER_TO_GLOBAL_MASTER = 0x0014,
    UBSE_MEM_SHARE_ATTACH_IMPORT_AGENT_TO_CASCADE_MASTER = 0x0015,
    UBSE_MEM_SHARE_DETACH_CASCADE_MASTER_TO_MANAGE_MASTER = 0x0016,         
    UBSE_MEM_SHARE_DETACH_MANAGE_MASTER_TO_GLOBAL_MASTER = 0x0017,
    UBSE_MEM_SHARE_DETACH_CASCADE_MASTER_HANDLE = 0x0018,
    UBSE_MEM_SHARE_DELETE_CASCADE_MASTER_HANDLE = 0x0019,
    UBSE_MEM_SHARE_DELETE_CASCADE_MASTER_TO_GLOBAL_MASTER = 0x0020,
    UBSE_MEM_SHARE_DETACH_IMPORT_CASCADE_MASTER_TO_GLOBAL_MASTER = 0x0021,
    UBSE_MEM_SHARE_BORROW_FORWARD_CASCADE_MASTER_TO_GLOBAL_MASTER = 0x0022,
    UBSE_MEM_SHARE_ATTACH_FORWARD_CASCADE_MASTER_TO_GLOBAL_MASTER = 0x0023,
    UBSE_MEM_SHARE_RETURN_FORWARD_CASCADE_MASTER_TO_GLOBAL_MASTER = 0x0024,
};
